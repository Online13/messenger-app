...
export default function Page() {
	return (
		<View>
			<Header
				title="Settings"
				icon={<Feather name="moon" size={28} color="black" />}
			/>
			<View style={styles.info}>
				<View>
					<Image
						...
						source={{
							uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGeYCl1zuDIBzoAGV-Isbahh6xmIDclTBs5A&usqp=CAU",
						}}
					/>
			...
			<View style={[styles.listMenu, styles.flex]}>
				<TouchableOpacity
					style={[styles.flex, styles.spacebetween, styles.menu]}
				>
